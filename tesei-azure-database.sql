...
CREATE TABLE `leads` (
  ...
  CONSTRAINT `leads_ibfk_2` FOREIGN KEY (`sales_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `leads_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `lead_status` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `follow_ups` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
	...
	CONSTRAINT `follow_ups_ibfk_2` FOREIGN KEY (`sales_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reminders` (
  ...
  CONSTRAINT `reminders_ibfk_1` FOREIGN KEY (`followup_id`) REFERENCES `follow_ups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
